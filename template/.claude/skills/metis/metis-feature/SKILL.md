...
- `decomposing-build-into-epics` — epic mode, before proposing the new epic.
- `writing-an-epic-file` — epic mode, before scaffolding the epic.
- `decomposing-work-into-tasks` — before proposing tasks.
- `writing-a-task-file` — before writing tasks.
