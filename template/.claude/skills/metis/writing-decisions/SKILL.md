...
A decision file is a standing record of a choice that spans epics and sessions. The job of this skill is to keep each decision short, honest, and findable — and to catch the cases where a single "decision" is actually two, or where no decision was really needed in the first place.
...
- **Consequences** is concrete — what this enables, what it costs, what it forecloses. Not aspirational ("we'll see how it goes"), not a reassurance ("this should be fine"). If you cannot name at least one concrete downstream effect, you may not have understood the decision well enough to commit it.
