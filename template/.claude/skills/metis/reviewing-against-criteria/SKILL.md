---
name: reviewing-against-criteria
description: Reference for writing one review verdict — per-criterion pass/fail with evidence, scope reduction named as a finding, code quality kept separate from spec compliance, and the verdict triage among approve / approve-with-nits / reject-with-reasons.
