...
description: Reference for reading a docs corpus thoroughly, distinguishing real contradictions and gray areas from wording noise, and capturing each finding as a well-framed open item without pre-resolving it.
