...
description: Reference for researching one technical question against the open web — scoping the question, investigation register, citation discipline, surfacing tradeoffs without picking favorites, calibrating confidence, anchoring to the project's stated constraints, and the research note's shape.
