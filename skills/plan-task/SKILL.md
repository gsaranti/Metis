...
The trailing prompt is forwarded to the subagent verbatim. The four discipline rules live canonically in `.metis/conventions/command-prompts.md` and are enforced inside `task-planner.md`.
